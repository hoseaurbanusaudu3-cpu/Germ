...
import { FileText, Printer, Download, AlertCircle, Eye } from 'lucide-react';
                          ...
                          <div>
                            ...
                            <div className="border border-gray-200 rounded-lg p-4 bg-gray-50 space-y-2 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span className="text-gray-900 font-medium">{affective.punctuality}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Attendance:</span>
                                <span className="text-gray-900 font-medium">{affective.attendance}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Neatness:</span>
                                <span className="text-gray-900 font-medium">{affective.neatness}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Politeness:</span>
                                <span className="text-gray-900 font-medium">{affective.politeness}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Honesty:</span>
                                <span className="text-gray-900 font-medium">{affective.honesty}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Relationship:</span>
                                <span className="text-gray-900 font-medium">{affective.relationship}/5</span>
                              </div>
                            </div>
                          </div>
                        )}
                          ...
                          <div>
                            ...
                            <div className="border border-gray-200 rounded-lg p-4 bg-gray-50 space-y-2 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span className="text-gray-900 font-medium">{psychomotor.handwriting}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Sports:</span>
                                <span className="text-gray-900 font-medium">{psychomotor.sports}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Arts & Crafts:</span>
                                <span className="text-gray-900 font-medium">{psychomotor.artsCrafts}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Musical Skills:</span>
                                <span className="text-gray-900 font-medium">{psychomotor.musicalSkills}/5</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-700">Dexterity:</span>
                                <span className="text-gray-900 font-medium">{psychomotor.dexterity}/5</span>
                              </div>
                            </div>
                          </div>
                        )}
