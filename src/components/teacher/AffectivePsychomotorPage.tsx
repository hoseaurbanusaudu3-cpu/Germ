...
export function AffectivePsychomotorPage() {
  ...
  const handleSave = () => {
    ...
    const affectiveData = {
      ...
      attentivenessRemark: affectiveRatings.attentiveness.remark || getRatingLabel(affectiveRatings.attentiveness.value),
      honesty: affectiveRatings.honesty.value,
      honestyRemark: affectiveRatings.honesty.remark || getRatingLabel(affectiveRatings.honesty.value),
      neatness: affectiveRatings.neatness.value,
      neatnessRemark: affectiveRatings.neatness.remark || getRatingLabel(affectiveRatings.neatness.value),
      obedience: affectiveRatings.obedience.value,
      obedienceRemark: affectiveRatings.obedience.remark || getRatingLabel(affectiveRatings.obedience.value),
      senseOfResponsibility: affectiveRatings.senseOfResponsibility.value,
      senseOfResponsibilityRemark: affectiveRatings.senseOfResponsibility.remark || getRatingLabel(affectiveRatings.senseOfResponsibility.value),
