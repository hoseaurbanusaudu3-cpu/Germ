...
export function ScoreEntryPage() {
  ...
  const availableSubjects = useMemo(() => {
    ...
    return teacherAssignments.filter(a => a.classId === Number(selectedClassId));
  ...
  const handleImportCSV = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      ...
      dataLines.forEach(line => {
        ...
        const [name, admNum, ca1, ca2, exam] = parts.map(p => p.trim());
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white rounded-xl shadow-clinical"
                  disabled={isLocked}
                >
