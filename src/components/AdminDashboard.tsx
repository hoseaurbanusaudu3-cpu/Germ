    ...
    <div className="min-h-screen bg-[#F4F6F9]">
      ...
      <div className="lg:pl-64">
        ...
        <main className="p-4 md:p-6 max-w-7xl mx-auto">
                ...
                <CardContent className="p-4">
                  <div className="grid md:grid-cols-3 gap-3">
                    <div className="p-3 bg-[#F9FAFB] rounded-lg border border-[#E5E7EB]">
                      ...
                      <p className="text-[#1F2937] font-medium">2024/2025</p>
                    </div>
                    <div className="p-3 bg-[#F9FAFB] rounded-lg border border-[#E5E7EB]">
                      <p className="text-[#6B7280] mb-1 text-sm">Current Term</p>
                      <p className="text-[#1F2937] font-medium">Second Term</p>
                    </div>
                    <div className="p-3 bg-[#F9FAFB] rounded-lg border border-[#E5E7EB]">
          ...
          {!["dashboard", "register-user", "add-student", "manage-students", "manage-teachers", "manage-parents", "manage-classes", "manage-subjects", "teacher-assignments", "promotion-system", "approve-results", "view-results", "link-student-parent", "fee-management", "send-notifications", "notifications", "activity-logs", "data-backup", "settings"].includes(activeItem) && (
            <div className="space-y-6">
