...
export function NotificationSystemPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    message: "",
    recipient: "",
    priority: "normal" as 'info' | 'warning' | 'success' | 'error',
  });
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setSelectedRoles({ ...selectedRoles, teachers: checked as boolean })}
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setSelectedRoles({ ...selectedRoles, parents: checked as boolean })}
                          className="border-white/20"
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setSelectedRoles({ ...selectedRoles, accountants: checked as boolean })}
                          className="border-white/20"
                        />
