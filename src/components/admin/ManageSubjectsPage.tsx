    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl rounded-2xl bg-[#132C4A] border border-white/10 text-white">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select value={formData.level} onValueChange={(value: "Primary" | "Secondary") => setFormData({ ...formData, level: value })}>
                ...
                <SelectContent className="bg-[#0F243E] border-white/10">
                  ...
                  <SelectItem value="Secondary" className="text-white hover:bg-[#1E90FF]">Secondary</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.department} onValueChange={(value: string) => setFormData({ ...formData, department: value })}>
                ...
                <SelectContent className="bg-[#0F243E] border-white/10">
                  ...
                  <SelectItem value="Languages" className="text-white hover:bg-[#1E90FF]">Languages</SelectItem>
                  <SelectItem value="Social Sciences" className="text-white hover:bg-[#1E90FF]">Social Sciences</SelectItem>
                  <SelectItem value="Mathematics" className="text-white hover:bg-[#1E90FF]">Mathematics</SelectItem>
                  <SelectItem value="Arts" className="text-white hover:bg-[#1E90FF]">Arts</SelectItem>
                  <SelectItem value="Vocational" className="text-white hover:bg-[#1E90FF]">Vocational</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <Button
            onClick={onSubmit}
            className="bg-[#1E90FF] hover:bg-[#00BFFF] text-white rounded-xl shadow-md hover:scale-105 transition-all"
          >
            <Check className="w-4 h-4 mr-2" />
            {title.includes("Create") ? "Create Subject" : "Save Changes"}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
